...
class Config(object):
    ...
    API_HASH = "jhj"
    TOKEN = "faddas"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = "32324"  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "daf"
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "29sw~DSF"  # go to support.spamwat.ch to get key
...
"2039336161" "5153636966" "5213143273" "5555455171")
    ...
    CASH_API_KEY = (
        "ds"  # Get your API key from https://www.alphavantage.co/support/#api-key
    )
    TIME_API_KEY = "S"  # Get your API key from https://timezonedb.com/api
    WALL_API = (
